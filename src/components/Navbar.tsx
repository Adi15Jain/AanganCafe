    ...
    return (
        <motion.header
            ...
            className={`fixed top-0 left-0 right-0 z-50 transition-all duration-700 ${
                scrolled
                    ? "bg-[rgba(12,14,19,0.6)] backdrop-blur-2xl border-b border-white/[0.06] shadow-[0_4px_30px_rgba(0,0,0,0.3)]"
        ...
        >
            <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex items-center justify-between h-16 sm:h-20">
                    ...
                    >
                        <span className="text-2xl sm:text-[1.8rem] font-heading font-bold text-white tracking-tight leading-none overflow-hidden text-clip whitespace-nowrap">
                            Aangan
                        </span>
                    ...
                    {isOpen && (
                        ...
                        >
                            <ul
                                ...
                                bg-[rgba(12,14,19,0.8)] backdrop-blur-2xl
                            ...
                            >
                                ...
                                >
                                    <Link
                                        to="/contact"
                                        className="block text-center px-4 py-3 bg-gradient-to-r from-primary to-primary-dark text-white rounded-xl text-sm font-semibold
